...
namespace System.Text.RegularExpressions
{
    ...
    public class Match : Group
    {
        ...
        // Whether we've done any balancing with this match.  
        // If we have done balancing, we'll need to do extra work in Tidy().
        ...
        public virtual string Result(string replacement)
        {
            ...
            RegexReplacement repl = (RegexReplacement)_regex._replref.Get();
        ...
        /// <summary>
        /// Add a capture to balance the specified group.  This is used by the balanced match construct. (?<foo-foo2>...).
